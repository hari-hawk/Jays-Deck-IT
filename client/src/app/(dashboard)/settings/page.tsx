            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ background: 'var(--bg-secondary)' }}>
                  <th className="border-b px-4 py-3 text-left font-mono text-xs uppercase tracking-wider" style={{ color: 'var(--text-tertiary)', borderColor: 'var(--border-primary)' }}>User</th>
                  <th className="border-b px-4 py-3 text-left font-mono text-xs uppercase tracking-wider hidden md:table-cell" style={{ color: 'var(--text-tertiary)', borderColor: 'var(--border-primary)' }}>Email</th>
                  <th className="border-b px-4 py-3 text-left font-mono text-xs uppercase tracking-wider hidden lg:table-cell" style={{ color: 'var(--text-tertiary)', borderColor: 'var(--border-primary)' }}>Department</th>
                  <th className="border-b px-4 py-3 text-left font-mono text-xs uppercase tracking-wider" style={{ color: 'var(--text-tertiary)', borderColor: 'var(--border-primary)' }}>Role</th>
                ...
                {mockSlaConfig.map((sla) => (
                  <div key={sla.priority} className="grid grid-cols-3 gap-4 items-end rounded-lg border p-4" style={{ borderColor: 'var(--border-primary)' }}>
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs" style={{ color: 'var(--text-tertiary)' }}>Response Time</Label>
                      <div className="flex items-center gap-2">
                        <Input
                          type="number"
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs" style={{ color: 'var(--text-tertiary)' }}>Resolution Time</Label>
                      <div className="flex items-center gap-2">
                        <Input
                          type="number"

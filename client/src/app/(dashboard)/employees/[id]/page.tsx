...
import { ArrowLeft, Mail, Phone, MapPin, Calendar, Building, Monitor, Ticket } from 'lucide-react';
  ...
  if (!employee) {
    return (
      <div className="flex flex-col items-center justify-center py-24">
        <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>Employee not found</p>
        <Link href="/employees" className="mt-4 text-sm font-medium" style={{ color: 'var(--accent-primary)' }}>
          Back to People Link
        </Link>
      </div>
    );
